...
# Parameters
TILE_SIZE = 512
STRIDE = 512  # use < TILE_SIZE for overlap
INPUT_IMAGE_DIR = "Processed"
OUTPUT_IMAGE_DIR = "TiledImages"
OUTPUT_CSV_PATH = "tiled_annotations.csv"
...
for image_name in image_names:
    image_path = os.path.join(INPUT_IMAGE_DIR, os.path.splitext(image_name)[0] + ".tiff")
